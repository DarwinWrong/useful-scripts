...
echo ==========================================
echo.
echo [1] Запустити програми
echo [2] Встановити програми
echo [3] Оновити програми
echo [4] Видалити програми
echo [0] Вихід
echo.
set /p main_choice=Оберіть розділ: 
...
echo [0] Назад
echo.
set /p run_choice=Оберіть програму: 
...
echo [0] Назад
echo.
set /p install_choice=Оберіть програму: 
...
echo [0] Назад
echo.
set /p update_choice=Оберіть програму: 
...
echo [0] Назад
echo.
set /p uninstall_choice=Оберіть програму: 
